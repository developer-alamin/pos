                            ...
                            <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" class="form-control qty"
                                                            name="product_qty[]" value="{{$qty_list[$key]}}" step="any">
                                                    </td>
                                ...
                                <div class="col-md-12 mt-2" id="diffPrice-option">
                                    ...
                                    <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice" value="1"
                                            checked>&nbsp; {{trans('file.This product has different price for different
                                        warehouse')}}</h5>
                                    @else
                                    <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice" value="1">&nbsp;
                                ...
                                <div class="col-md-12 mt-3" id="imei-option">
                                    ...
                                    <h5><input name="is_imei" type="checkbox" id="is-imei" value="1" checked>&nbsp;
                                        {{trans('Managed Serialized Inventory for this Item?')}}</h5>
                                    @else
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4" id="promotion_price"> <label>{{trans('file.Promotional
                                                Price')}}</label>
                                ...
                                <div class="col-md-12 my-3">
                                    <i class="fa fa-info-circle"></i> &nbsp; <span class="text-info">{{
                                        $lims_product_data->qty }} Items are
                                        avaiable to
                                        serialized.</span> <a href="{{ route('serial.index', $lims_product_data->id) }}"
                                        class="btn btn-info btn-sm">Generate
                                        Serial</a>
                                </div>
                                @endif
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="button" value="{{trans('file.submit')}}" class="btn btn-primary"
                                            id="submit-btn">
                                    </div>
                                </div>
                            </div>
