                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('Product Qty')}} *</strong> </label>
                                        <input type="number" name="qty" class="form-control" id="qty" aria-describedby="qty" required>
                                        <span class="validation-msg" id="qty-error"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_details" class="form-control ckeditor-classic" rows="3"></textarea>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script src="{{asset('assets/build/libs/@ckeditor/ckeditor5-build-classic/build/ckeditor.js')}}"></script>
