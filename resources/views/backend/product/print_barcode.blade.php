                        ...
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr data-imagedata="{{$preLoadedproduct[3]}}"
                                                        ...
                                                        @if ($serials != null)
                                                        <td class="serial-key">{{$serials->serials}}</td>
                                                        @endif
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <strong><input type="checkbox" name="name" checked /> {{trans('Product
                                        Name')}}</strong>&nbsp;
                                    <strong><input type="checkbox" name="price" checked />
                                        {{trans('file.Price')}}</strong>&nbsp;
                                    <strong><input type="checkbox" name="promo_price" /> {{trans('Promotional
                                        Price')}}</strong>
                                    @if ($serials != null)
                                    <strong><input type="checkbox" name="serial" /> {{trans('Serial Key')}}</strong>
                                    @endif
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
    ...
    $("#submit-button").on("click", function(event) {
        ...
        if(paper_size != "0") {
            ...
            for(i = 0; i <= rownumber; i++){
                ...
                serial.push($('table.order-list tbody tr:nth-child(' + (i + 1) + ')').find('td:nth-child(3)').text());
            ...
            $.each(qty, function(index){
                ...
                while(i < qty[index]) {
                    ...
                    if($('input[name="code"]').is(":checked"))
                        htmltext += '<strong>'+code[index]+'</strong><br>';
                    if($('input[name="serial"]').is(":checked"))
                    htmltext += '<strong>S-'+serial[index]+'</strong><br>';
