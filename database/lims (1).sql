...
(2, 'Samsung', NULL, 1, '2023-09-03 09:17:26', '2023-09-03 09:17:26');
...
(1, 10000, 1, 1, 0, '2023-08-19 20:00:35', '2023-08-19 20:05:42'),
(2, 100, 1, 1, 1, '2023-08-19 20:06:02', '2023-08-19 20:06:02');
...
(1, 'Mobile', '20231022052106.png', NULL, 1, '2022-07-31 12:15:28', '2023-10-22 11:21:06'),
(2, 'Charger', '20231001114222.jpg', NULL, 1, '2023-10-01 17:42:22', '2023-10-01 17:42:22');
...
(2, 'er-20230831-052618', 1, 1, 5, 1, 2, 100, NULL, '2023-08-30 18:00:00', '2023-08-31 11:26:18');
...
(1, 'FIX4YOU CELLULAR', '20230824032408.jpg', 0, '1', 'own', 'd-m-Y', 'FIX4YOU', 'standard', 1, 'default.css', '2018-07-06 18:13:11', '2023-08-23 21:24:08', 'prefix');
...
--
-- Table structure for table `ip_tv_apps`
--

CREATE TABLE `ip_tv_apps` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `icon` varchar(191) NOT NULL,
  `app_name` varchar(191) NOT NULL,
  `link` varchar(191) DEFAULT NULL,
  `apk_file` varchar(191) DEFAULT NULL,
  `user_id` varchar(191) DEFAULT NULL,
  `is_home` varchar(191) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ip_tv_apps`
--

INSERT INTO `ip_tv_apps` (`id`, `icon`, `app_name`, `link`, `apk_file`, `user_id`, `is_home`, `created_at`, `updated_at`) VALUES
(4, '20231022051835.png', 'tv 1', NULL, NULL, NULL, '0', '2023-10-22 11:18:35', '2023-10-23 07:39:32'),
(5, '20231023021523.png', 'Youtube', NULL, NULL, NULL, '0', '2023-10-22 11:19:01', '2023-10-23 08:15:23'),
(6, '20231023101843.png', 'New App', NULL, '20231023101843.jpeg', '21', 'on', '2023-10-23 16:18:43', '2023-10-23 16:18:43'),
(7, '20231024085659.jpeg', 'test 3', NULL, NULL, '19', '0', '2023-10-24 02:56:59', '2023-10-24 02:56:59');

-- --------------------------------------------------------

--
-- Table structure for table `ip_tv_settings`
--

CREATE TABLE `ip_tv_settings` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
(157, '2023_08_26_021353_add_is_serialization_to_products', 103),
(159, '2023_08_26_023843_create_serials_table', 104),
(160, '2023_10_20_205358_create_ip_tv_settings_table', 105),
(161, '2023_10_21_191743_create_ip_tv_apps_table', 106);
...
(5, 'spr-20230820-020335', 1, NULL, 5, 1, 5, 820, NULL, 0, 'Cash', NULL, '2023-08-19 20:03:35', '2023-08-19 20:03:35'),
(6, 'spr-20230904-094951', 1, NULL, 6, 2, 5, 880, NULL, 0, 'Cash', NULL, '2023-09-04 03:49:51', '2023-09-04 03:49:51');
...
(124, 'subcription-index', 'web', '2018-06-05 11:15:54', '2018-06-05 11:15:54');
...
INSERT INTO `products` (`id`, `name`, `code`, `type`, `barcode_symbology`, `brand_id`, `category_id`, `unit_id`, `purchase_unit_id`, `sale_unit_id`, `cost`, `price`, `qty`, `alert_quantity`, `daily_sale_objective`, `promotion`, `promotion_price`, `starting_date`, `last_date`, `tax_id`, `tax_method`, `image`, `file`, `is_embeded`, `is_variant`, `is_batch`, `is_diffPrice`, `is_imei`, `featured`, `product_list`, `variant_list`, `qty_list`, `price_list`, `product_details`, `variant_option`, `variant_value`, `is_active`, `created_at`, `updated_at`, `is_serialization`) VALUES
(1, 'iPhoneX', '99265514', 'standard', 'C128', 1, 1, 1, 1, 1, 800, 1000, 7, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '202207311136192.jpg', NULL, 0, NULL, NULL, 0, NULL, 1, NULL, NULL, NULL, NULL, '', NULL, NULL, 1, '2022-07-31 12:18:28', '2023-09-04 03:49:44', 0),
(2, 'iPhone11', '54733219', 'standard', 'C128', 1, 1, 1, 1, 1, 400, 600, 10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'zummXD2dvAtI.png', NULL, 1, NULL, NULL, 0, 1, 0, NULL, NULL, NULL, NULL, '', NULL, NULL, 1, '2022-07-31 16:38:57', '2023-08-25 20:34:17', 0),
(3, 'Samsung A22', '67620129', 'standard', 'C128', 2, 1, 1, 1, 1, 10000, 10000, 100, 10, 1000, NULL, NULL, NULL, NULL, NULL, 1, '1693736311188carbon.png', NULL, 1, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '<p>Product Details</p>', NULL, NULL, 1, '2023-09-03 10:18:50', '2023-09-03 10:18:50', 0);
...
(5, 5, 1, NULL, NULL, NULL, 1, 1, 900, 0, 0, 0, 900, '2023-08-19 20:03:21', '2023-08-19 20:03:21'),
(6, 6, 1, NULL, NULL, NULL, 1, 1, 900, 0, 0, 0, 900, '2023-09-04 03:49:44', '2023-09-04 03:49:44');
...
(1, '1', NULL, NULL, NULL, 1, 7, NULL, '2022-07-31 12:21:45', '2023-09-04 03:49:44');
...
(5, 'posr-20230820-020321', 1, 1, 1, 1, 1, 1, 1, 0, 0, 900, 820, 0, 0, 'Percentage', 10, 90, NULL, NULL, 10, 1, 4, NULL, 820, NULL, NULL, '2023-08-19 18:00:00', '2023-08-19 20:03:21'),
(6, 'posr-20230904-094943', 1, 2, 1, 1, 1, 1, 1, 0, 0, 900, 880, 0, 0, 'Flat', 20, 20, NULL, NULL, NULL, 1, 4, NULL, 880, NULL, NULL, '2023-09-04 03:49:43', '2023-09-04 03:49:43');
...
INSERT INTO `serials` (`id`, `product_id`, `cost`, `price`, `brand_id`, `color`, `network`, `size`, `condition`, `warranty`, `serials`, `status`, `created_at`, `updated_at`) VALUES
(1, 2, 400.00, 600.00, 1, 'black', '2g', '264', 'new', '1 Years', '7215332661', 'In Stock', '2023-08-26 11:03:40', '2023-08-26 11:03:40'),
(2, 2, 400.00, 600.00, 1, 'black', '2g', '264', 'new', '1 Years', '5304379810', 'In Stock', '2023-08-26 11:03:40', '2023-08-26 11:03:40'),
(3, 2, 500.00, 600.00, 1, 'black', '2g', '264', 'new', '1 Years', '2073654321', 'In Stock', '2023-08-26 11:03:41', '2023-08-31 13:36:08'),
(6, 2, 400.00, 600.00, 1, 'black', '5g', '264', 'new', '1 Years', '6973048428', 'In Stock', '2023-08-26 11:03:41', '2023-08-31 15:24:39'),
(7, 2, 400.00, 600.00, 1, 'black', '2g', '264', 'new', '1 Years', '1133469858', 'In Stock', '2023-08-26 11:03:41', '2023-08-26 11:03:41'),
(8, 2, 400.00, 600.00, 1, 'black', '2g', '264', 'new', '1 Years', '7118005942', 'In Stock', '2023-08-26 11:03:41', '2023-08-26 11:03:41'),
(9, 2, 400.00, 600.00, 1, 'black', '2g', '264', 'new', '1 Years', '5597492435', 'In Stock', '2023-08-26 11:03:41', '2023-08-26 11:03:41'),
(10, 2, 400.00, 600.00, 1, 'black', '2g', '264', 'new', '1 Years', '2577931861', 'In Stock', '2023-08-26 11:03:41', '2023-08-26 11:03:41');
...
(1, 'scr-20230826-024123', 1, NULL, NULL, 1, 'full', '20230826-024123.csv', NULL, NULL, 0, '2023-08-25 20:41:23', '2023-08-25 20:41:23');
...
(1, 'admin', 'admin@admin.com', '$2y$10$bAohnTAlLvuIBX5t7i3ZleDVb43D4nEDVyrtX5DHl9B7pxU.AcqOy', 'G5XMtYh9lESOjjQpkZKtZYpmOvNy03wEDMluO98i23IIJu6k76CbADeAFszA', '5364377', 'nulled', 1, NULL, NULL, 1, 0, '2018-06-02 15:24:15', '2022-07-16 08:38:25'),
(3, 'dhiman da', 'dhiman@gmail.com', '$2y$10$Fef6vu5E67nm11hX7V5a2u1ThNCQ6n9DRCvRF9TD7stk.Pmt2R6O.', 'GnX1BiMTAGsHzOBnqnbycSKnRWDpn3CcyTUcOe4L4wB2IuWvkmqEXPG3TQox', '212', 'lioncoders', 1, 0, 0, 0, 1, '2018-06-14 10:00:31', '2020-11-05 19:06:51'),
...
(19, 'shakalaka', 'shakalaka@gmail.com', '$2y$10$bAohnTAlLvuIBX5t7i3ZleDVb43D4nEDVyrtX5DHl9B7pxU.AcqOy', '', '1212', 'Digital image', 5, 0, 0, 1, 1, '2020-11-09 12:07:16', '2022-07-16 08:35:32'),
...
(37, 'azhar', 'azharul321@gmail.com', '$2y$10$bAohnTAlLvuIBX5t7i3ZleDVb43D4nEDVyrtX5DHl9B7pxU.AcqOy', NULL, '01679661334', 'New Company', 1, NULL, NULL, 0, 0, '2023-10-19 17:04:00', '2023-10-19 17:04:00');
...
--
-- Indexes for table `ip_tv_apps`
--
ALTER TABLE `ip_tv_apps`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ip_tv_settings`
--
ALTER TABLE `ip_tv_settings`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ip_tv_apps`
--
ALTER TABLE `ip_tv_apps`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `ip_tv_settings`
--
ALTER TABLE `ip_tv_settings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
